...
nJettiness = {
    ...
    "TauB_Inc_0j": [100, 0, 200.0, r'$\tau_{B,0}$ (Inclusive Jets)'],
    "TauB_Inc_1j": [100, 0, 200.0, r'$\tau_{B,1}$ (Inclusive Jets)'],
    "TauB_Inc_2j": [100, 0, 200.0, r'$\tau_{B,2}$ (Inclusive Jets)'],
    "TauB_JetConstituents_0j": [100, 0, 200.0, r'$\tau_{B,0}$  (Using Jet Const.)'],
    "TauB_JetConstituents_1j": [100, 0, 200.0, r'$\tau_{B,1}$  (Using Jet Const.)'],
    "TauB_JetConstituents_2j": [100, 0, 200.0, r'$\tau_{B,2}$  (Using Jet Const.)'],
    "TauC_Inc_0j": [100, 0, 70, r'$\tau_{C,0}$ (Inclusive Jets)'],
    "TauC_Inc_1j": [100, 0, 70, r'$\tau_{C,1}$ (Inclusive Jets)'],
    "TauC_Inc_2j": [50, 0, 70, r'$\tau_{C,2}$ (Inclusive Jets)'],
    "TauC_JetConstituents_0j": [100, 0, 70, r'$\tau_{C,0}$  (Using Jet Const.)'],
    "TauC_JetConstituents_1j": [100, 0, 70, r'$\tau_{C,1}$  (Using Jet Const.)'],
    "TauC_JetConstituents_2j": [50, 0, 70, r'$\tau_{C,2}$  (Using Jet Const.)'],
    "TauCnoHRapidity_JetConstituents_0j": [100, 0, 70, r'$\tau_{C,0}$  (Using Jet Const., without H)'],
    "TauCnoHRapidity_JetConstituents_1j": [100, 0, 70, r'$\tau_{C,1}$  (Using Jet Const., without H)'],
    "TauCnoHRapidity_JetConstituents_2j": [50, 0, 70, r'$\tau_{C,2}$  (Using Jet Const., without H)'],
    "TauCnoHRapidity_Inc_0j": [100, 0, 70, r'$\tau_{C,0}$  (Inclusive Jets, without H)'],
    "TauCnoHRapidity_Inc_1j": [100, 0, 70, r'$\tau_{C,1}$  (Inclusive Jets, without H)'],
    "TauCnoHRapidity_Inc_2j": [50, 0, 70, r'$\tau_{C,2}$  (Inclusive Jets, without H)'],
}
