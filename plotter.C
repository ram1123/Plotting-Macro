...
void plotter()
{
    ...
    c1->SaveAs("plots/eg_gen_et_EfficiencyComp.png");
    c1->Clear();

    c1 = CompareFun.GetTEfficiencyByDividingTwoHist("eg_gen_et", 35, 0, 1000, false, "eg_trkIsol<1.0 && abs(eg_eta)<1.47");
    c1->SaveAs("plots/eg_gen_et_EfficiencyComp_Barrel.png");
    c1->Clear();

    c1 = CompareFun.GetTEfficiencyByDividingTwoHist("eg_gen_et", 35, 0, 1000, false, "eg_trkIsol<1.0 && abs(eg_eta)>1.47");
    c1->SaveAs("plots/eg_gen_et_EfficiencyComp_Endcap.png");
    c1->Clear();
