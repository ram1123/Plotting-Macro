...
void TreeReaderCompare_Four(const plotVar_t plotvars[] = commonplotvars_genParticles){
  ...
  TString inputFile2 = "/uscms/home/rasharma/nobackup/double-higgs/GenSIMAnalyzer/CMSSW_10_2_22/src/GEN-SIM-analyzer/GenAnalyzer/Radion_hh_narrow_M500_LHEBqrk.root";
  TString inputFile3 = "/uscms/home/rasharma/nobackup/double-higgs/GenSIMAnalyzer/CMSSW_10_2_22/src/GEN-SIM-analyzer/GenAnalyzer/Radion_hh_narrow_M1000_LHEBqrk.root";
  TString inputFile4 = "/uscms/home/rasharma/nobackup/double-higgs/GenSIMAnalyzer/CMSSW_10_2_22/src/GEN-SIM-analyzer/GenAnalyzer/Radion_hh_narrow_M1500_LHEBqrk.root";
  ...
  for (int i = 0; i < variable.size(); ++i)
  {
    ...
    vectorOfTH1F3[i]->Draw("same");
    vectorOfTH1F4[i]->Draw("same");
    ...
    c1->SaveAs("plots/Log/"+outFileName[i]+"_log.pdf");    
    c1->Clear();
  }
}